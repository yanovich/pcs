/* logical-or.c -- calculate logical or
...
#define PCS_BLOCK	"logical-or"

struct logical_or_state {
...
static void
logical_or_run(struct block *b, struct server_state *s)
{
	struct logical_or_state *d = b->data;
...
{
	struct logical_or_state *d = data;
...
alloc(void)
{
	struct logical_or_state *d = xzalloc(sizeof(*d));
